/********************************************
START Program,OV2640_640x480_JPEG		Generated,Sun Sep  4 16:08:21 2016		Level:C++
********************************************/
...
const struct sensor_reg OV2640_640x480_JPEG[] =
{
	...
	{RB0_ZMOW,0xa0},                                 /*36	[5a := a0]		Zoom: Out Width  OUTW[7:0] (real/4)	 OUTW_SET(a0)/OUTW_SET(160) */
	{RB0_ZMOH,0x78},                                 /*37	[5b := 78]		Zoom: Out Height OUTH[7:0] (real/4)	 OUTH_SET(78)/OUTH_SET(120) */
	{RB0_ZMHH,0x00},                                 /*38	[5c := 00]		Zoom: Speed and H&W completion	 ZSPEED_SET(00)/ZSPEED_SET(0)  |  OUTW_SET(00)/OUTW_SET(0) */
	{RB0_R_DVP_SP,0x04},                             /*39	[d3 := 04]		DVP output speed control	0x04*/
