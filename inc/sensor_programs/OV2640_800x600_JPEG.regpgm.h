/********************************************
START Program,OV2640_800x600_JPEG		Generated,Sun Sep  4 16:08:21 2016		Level:C++
********************************************/
...
const struct sensor_reg OV2640_800x600_JPEG[] =
{
	...
	{RB0_CTRL,0x89},                                 /*29	[50 := 89]		RB0_CTRL	 LP_DP(80)/LP_DP  |  V_DIV_SET(01)/V_DIV_SET(1)  |  H_DIV_SET(01)/H_DIV_SET(1) */
	...
	{RB0_ZMOW,0xc8},                                 /*36	[5a := c8]		Zoom: Out Width  OUTW[7:0] (real/4)	 OUTW_SET(c8)/OUTW_SET(200) */
	{RB0_ZMOH,0x96},                                 /*37	[5b := 96]		Zoom: Out Height OUTH[7:0] (real/4)	 OUTH_SET(96)/OUTH_SET(150) */
