/********************************************
START Program,OV2640_1280x1024_JPEG		Generated,Sun Sep  4 16:08:21 2016		Level:C++
********************************************/
...
const struct sensor_reg OV2640_1280x1024_JPEG[] =
{
	...
	{RB0_ZMOW,0x40},                                 /*36	[5a := 40]		Zoom: Out Width  OUTW[7:0] (real/4)	 OUTW_SET(40)/OUTW_SET(64) */
	{RB0_ZMOH,0xf0},                                 /*37	[5b := f0]		Zoom: Out Height OUTH[7:0] (real/4)	 OUTH_SET(f0)/OUTH_SET(240) */
	{RB0_ZMHH,0x01},                                 /*38	[5c := 01]		Zoom: Speed and H&W completion	 ZSPEED_SET(00)/ZSPEED_SET(0)  |  OUTW_SET(01)/OUTW_SET(1) */
