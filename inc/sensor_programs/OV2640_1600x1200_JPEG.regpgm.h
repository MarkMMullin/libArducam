/********************************************
START Program,OV2640_1600x1200_JPEG		Generated,Sun Sep  4 16:08:21 2016		Level:C++
********************************************/
...
const struct sensor_reg OV2640_1600x1200_JPEG[] =
{
	...
	{RB0_HSIZE8,0xc8},                               /*26	[c0 := c8]		Image Horizontal Size HSIZE[10:3]	 SET(c8)/SET(200) */
	{RB0_VSIZE8,0x96},                               /*27	[c1 := 96]		Image Vertical Size VSIZE[10:3]	 SET(96)/SET(150) */
	...
	{RB0_ZMOW,0x90},                                 /*36	[5a := 90]		Zoom: Out Width  OUTW[7:0] (real/4)	 OUTW_SET(90)/OUTW_SET(144) */
	{RB0_ZMOH,0x2c},                                 /*37	[5b := 2c]		Zoom: Out Height OUTH[7:0] (real/4)	 OUTH_SET(2c)/OUTH_SET(44) */
	{RB0_ZMHH,0x05},                                 /*38	[5c := 05]		Zoom: Speed and H&W completion	 ZSPEED_SET(00)/ZSPEED_SET(0)  |  OUTH_SET(04)/OUTH_SET  |  OUTW_SET(01)/OUTW_SET(1) */
	{RB0_R_DVP_SP,0x02},                             /*39	[d3 := 02]		DVP output speed control	0x02*/
	{RB0_RESET,0x00},                                /*40	[e0 := 00]		Reset	0x00*/
	{0xFF,0xFF}
};
